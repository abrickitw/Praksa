...
public class Korisnici {
	...
	public long getVrsta_korisnka() {
		return vrsta_korisnka;
	}

	public void setVrsta_korisnka(long vrsta_korisnka) {
		this.vrsta_korisnka = vrsta_korisnka;
	}
	...
	public long getLogiranje() {
		return logiranje;
	}

	public void setLogiranje(long logiranje) {
		this.logiranje = logiranje;
	}
	...
	public String toString() {
		return "Korisnici [id_korisnik=" + id_korisnik + ", id_upravitelj=" + id_upravitelj + ", id_grad=" + id_grad
				+ ", vrsta_korisnka=" + vrsta_korisnka + ", aktivan=" + aktivan + ", salji_poruku=" + salji_poruku
				+ ", logiranje=" + logiranje + ", ime_prezime=" + ime_prezime + ", email=" + email + ", lozinka="
